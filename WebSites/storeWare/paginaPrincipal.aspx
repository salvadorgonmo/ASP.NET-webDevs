		...
		<div class="top-nav">
			...
			<ul class="nav1">
				 <li><a href="paginaPrincipal.aspx"><span class="primero"><i class="icon icon-house"></i></span>Home</a></li>
                        <li><a href="RegClient.aspx"><span class="segundo"><i class="icon icon-info"></i></span>Clientes</a></li>
                        <li><a href="RegProductos.aspx"><span class="tercero"><i class="icon icon-web"></i></span>Productos</a></li>
                        <li><a href="RegMetodoPago.aspx"><span class="cuarto"><i class="icon icon-house"></i></span>Metodos de pago</a></li>
                        <li><a href="RegistroVentas.aspx"><span class="quinto"><i class="icon icon-house"></i></span>Ventas</a></li>
                        <li><a href="rEnvios.aspx"><span class="sexto"><i class="icon icon-house"></i></span>Envios</a></li>
                        <li><a href="loguin.aspx" onclick="salir_Click" ><span class="octavo"><i class="icon icon-house"></i></span>Cerrar sesion</a></li>
