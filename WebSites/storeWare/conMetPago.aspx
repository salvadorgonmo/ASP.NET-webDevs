<%@ Page Language="C#" AutoEventWireup="true" CodeFile="conMetPago.aspx.cs" Inherits="conMetPago" %>
    ...
    <%--aqui empieza el menu--%>
		...
		<div class="top-nav">
            ...
            <li><a href="paginaPrincipal.aspx">Home</a></li>
                    ...
                    <li><a href="conMetPago.aspx">Consulta de pagos</a></li>
       ...
       <div class="container" style="margin-top:8%;width:70%;">
            ...
            <h1 style="text-align:center; padding:30px;color:gray;" >~Encuentra los mejores productos en nuestro catalogo~</h1>
                ...
                <div class="panel-body">
                    <asp:GridView CssClass="table-bordered table-responsive" runat="server" ID="conMetodoPago" AutoGenerateColumns="False" OnRowCommand="conMetodoPago_RowCommand" OnRowUpdating="conMetodoPago_RowUpdating1" OnRowEditing="conMetodoPago_RowEditing" OnRowCancelingEdit="conMetodoPago_RowCancelingEdit">
                        <Columns>
                            ...
                            <asp:ButtonField CommandName="eliminarMP" Text="Eliminar" HeaderText="Eliminación" />
                            <asp:CommandField HeaderText="Modificación" ShowEditButton="true" />
                        </Columns>
                    </asp:GridView>
                </div>
