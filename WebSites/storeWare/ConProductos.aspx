<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConProductos.aspx.cs" Inherits="ConProductos" %>
...
<body>
		...
		<div class="top-nav">
			...
			<ul class="nav1">
              ...
              <li><a href="ConCarrito.aspx">Ver carrito</a></li>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container" style="margin-top:8%;width:70%;">
          ...
          <div class=" table-responsive" style="width:110%;margin-right:10px; margin-top:10%;margin-bottom:10%;">
          <asp:GridView  CssClass=" table-bordered tabla" runat="server" ID="consultaProducto" AutoGenerateColumns="False" OnRowCommand="consultaProducto_RowCommand" OnRowEditing="consultaProducto_RowEditing" OnRowUpdating="consultaProducto_RowUpdating" OnRowCancelingEdit="consultaProducto_RowCancelingEdit" >
            <Columns>
                ...
                <asp:ButtonField HeaderStyle-ForeColor="Gray" HeaderStyle-Font-Size="Large" CommandName="eliminarProducto" Text="Eliminar" HeaderText="Eliminación" />
                ...
                <asp:CommandField HeaderStyle-ForeColor="Gray" HeaderStyle-Font-Size="Large" HeaderText="Modificación" ShowEditButton="true" />
            </Columns>
        </asp:GridView>
