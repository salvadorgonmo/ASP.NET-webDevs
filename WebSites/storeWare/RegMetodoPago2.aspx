<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegMetodoPago2.aspx.cs" Inherits="RegMetodoPago2" %>
		...
		<div class="top-nav">
			...
			<ul class="nav1">
				 <li><a href="paginaPrincipal2.aspx"><span class="primero"><i class="icon icon-house"></i></span>Home</a></li>
                    <li><a href="conMetPago2.aspx">Registro de productos</a></li>
        ...
        <div class="panel panel-default" style="background-color:rgba(0,0,0,0.4)">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" ID="empresa" placeholder="Ej. Banamex" MaxLength="20" CssClass="form-control cajita"/>
                </div>
                <div class="form-group">
                ...
                <asp:Button runat="server" ID="RegTargeta" Text="Enviar Datos" OnClick="RegCard_Click" CssClass="btn btn-default cajita"/>
                    </div>
                </div>
            </div>
             </div>
