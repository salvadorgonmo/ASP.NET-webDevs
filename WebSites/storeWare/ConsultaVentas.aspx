<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConsultaVentas.aspx.cs" Inherits="ConsultaVentas" %>
      ...
      <div>
            ...
            <div class="panel panel-default" style="background-color:rgba(0,0,0,0.4)">
                <div class="panel panel-heading" style="background-color:rgba(0, 0, 0, 0.39); color:white; text-align:center">
                    <h4 class="panel-title">Lista general de Ventas</h4>
                 </div>
                        <div class="panel-body">
                            <div class="form-group table-responsive">
                    <asp:GridView runat="server" CssClass="table table-bordered " ID="ConsultarVentas" AutoGenerateColumns="false" OnRowCommand="ConsultarVentas_RowCommand" OnRowEditing="ConsultarVentas_RowEditing" OnRowUpdating="ConsultarVentas_RowUpdating" OnRowCancelingEdit="ConsultarVentas_RowCancelingEdit" >
                        <Columns>
                            ...
                            <asp:ButtonField CommandName="EliminarVentas" Text="Eliminar Ventas" HeaderText="Eliminar" ControlStyle-CssClass="calendarios"/>
