<%@ Page Language="C#" AutoEventWireup="true" CodeFile="conCarrito2.aspx.cs" Inherits="conCarrito2" %>
...
<body>
		...
		<div class="top-nav">
			...
			<ul class="nav1">
              <li><a href="paginaPrincipal2.aspx">Home</a></li>
                    <li><a href="ConProductos2.aspx">Consulta de productos</a></li>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container" style="margin-top:8%">
            ...
            <h1 style="text-align:center; padding:30px;color:gray;" >~Tus productos hasta el momento:~</h1>
            </div>
            </div>
            
            
          <div class=" panel-body" style="width:100%; margin-top:8%;margin-bottom:10%;">
          <asp:GridView  CssClass=" table-bordered tabla" runat="server" ID="consultaCarrito" AutoGenerateColumns="False" >
            <Columns>
                <asp:BoundField HeaderStyle-ForeColor="Gray" HeaderStyle-Font-Size="Large" DataField="id" HeaderText="ID" ReadOnly="true" />
                <asp:BoundField ControlStyle-BorderColor="Gray" HeaderStyle-ForeColor="Gray" HeaderStyle-Font-Size="Larger" DataField="descripcion" HeaderText="Descripcion" />
                ...
                <asp:BoundField HeaderStyle-ForeColor="Gray" HeaderStyle-Font-Size="Large" DataField="categoriacar" HeaderText="Categoria" />
                <asp:BoundField HeaderStyle-ForeColor="Gray" HeaderStyle-Font-Size="Large" DataField="pUnitario" HeaderText="Precio Unitario" />
                <asp:ButtonField HeaderStyle-ForeColor="Gray" HeaderStyle-Font-Size="Large" CommandName="eliminaCarrito" Text="Eliminar" HeaderText="Eliminación" />
                <asp:BoundField HeaderStyle-ForeColor="Gray" HeaderStyle-Font-Size="Large" DataField="codBarra" HeaderText="Codigo de Barra" />
                <asp:BoundField HeaderStyle-ForeColor="Gray" HeaderStyle-Font-Size="Large" DataField="total" HeaderText="Total" />
        
                 </Columns>
        </asp:GridView>
              
               <asp:label CssClass="label" runat="server" ID="label1" >Tex</asp:label>
               <asp:label CssClass="label2" runat="server" ID="label2" >Total:</asp:label> 
              <div class="form-group" style="text-align:center">
                    <br />
                   <br />
                    <asp:Button runat="server" ID="regCar" Text="Comprar"  CssClass="btn btn-success cajita" OnClick="regCar_Click" />
                   <asp:Button runat="server" ID="seguirComp" Text="Seguir comprando" CssClass="btn btn-danger" OnClick="seguirCom_Click" />
                </div>
             </div>
