<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rEnvios.aspx.cs" Inherits="rEnvios" %>
   ...
   <nav class="">
		...
		<div class="top-nav">
			...
			<ul class="nav1">
                 ...
                 <li><a href="rEnvios.aspx">Registro de envios</a></li>
                 <li><a href="consultaEnvios.aspx">Consultar envios</a></li>
        ...
        <div class="panel panel-default" style="background-color:rgba(0,0,0,0.4)">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" onkeypress="return onKeyDecimal(event,this);" ID="costo" placeholder="Ingresar costo de envio" CssClass="form-control cajita" />
                </div><br /><br />
                <div class="form-group" style="text-align:center"><br /><br />
