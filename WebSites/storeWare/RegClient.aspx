<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegClient.aspx.cs" Inherits="RegClient" %>
...
<body>
    ...
    <div class="container" style="margin-top:8%">
        ...
        <asp:TextBox onkeypress="return soloNumeros(event);" CssClass="form-control tex" runat="server" ID="idcliente" MaxLength="11" ></asp:TextBox>
        <br />
        <asp:Label CssClass="label" runat="server">Nombre: </asp:Label>
        <asp:TextBox onkeypress="return soloLetras(event);" CssClass="form-control tex" runat="server" ID="nombre" MaxLength="20"></asp:TextBox>
        <br />
        ...
        <asp:TextBox onkeypress="return soloNumeros(event);" CssClass="form-control tex" runat="server" ID="telefono" MaxLength="15" ></asp:TextBox>
        <br />
