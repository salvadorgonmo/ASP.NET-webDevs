<%@ Page Language="C#" AutoEventWireup="true" CodeFile="conClient2.aspx.cs" Inherits="conClient2" %>
    ...
    <%--aqui empieza el menu--%>
		...
		<div class="top-nav">
            ...
            <li><a href="paginaPrincipal2.aspx">Home</a></li>
                    <li><a href="RegClient2.aspx">Registro de clientes</a></li>
        ...
        <div class="panel panel-default" style="background-color:rgba(0,0,0,0.5)">
            <div class="panel-heading"> 
                <div class="panel-title">
                    <h1 style="color:black">StoreWare</h1>
                </div>
            </div>
            <div class="panel-body">
                <div class="panel panel-title" style="background-color:rgba(0,0,0,0.5)">
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" OnTextChanged="TextBox1_TextChanged" Width="237px" AutoPostBack="true" onChange="actualizar()" CssClass="cajas2"></asp:TextBox>
                </div>
                  <div class="table-responsive"> 
                <asp:GridView CssClass="table-bordered table tabla" runat="server" ID="conCliente" AutoGenerateColumns="False">
            <Columns>
