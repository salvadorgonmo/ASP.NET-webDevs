<%@ Page Language="C#" AutoEventWireup="true" CodeFile="consultaEnvios2.aspx.cs" Inherits="consultaEnvios2" %>
                ...
                <div class="panel panel-default" style="background-color: rgba(0,0,0,0.4)">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <asp:GridView runat="server" ID="ConsultaEnvios" AutoGenerateColumns="false"  CssClass="calendarios" >
                                <Columns>
